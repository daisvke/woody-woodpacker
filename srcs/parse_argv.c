...
int	_ww_parse_argv(char *argv[])
{
	...
	_modes |= _WW_INSTREG_PAD;				// Insert inside segments paddings
	// _modes |= _WW_INSTREG_SFT,			// Insert at 0x0 and shift the rest
	// _modes |= _WW_INSTREG_END			// Insert at the end of the file
	return 0;
}